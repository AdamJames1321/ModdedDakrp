...
TEAM_POLICE = AddExtraTeam("Police Officer", {
	...
	description = [[You protect Downtown. Don't abuse you're job. You make sure no one breaks the law.]],
...
TEAM_CHIEF = AddExtraTeam("Police Chief", {
	...
	description = [[The Chief is the leader of the Police.
...
TEAM_MAYOR = AddExtraTeam("President", {
	...
	PlayerDeath = function(ply, weapon, killer)
                if( ply:Team() == TEAM_MAYOR ) then
                        ...
                        for k,v in pairs( player.GetAll() ) do
                                v:PrintMessage( HUD_PRINTCENTER, "The President has been killed! Oh no!" )
                        end
                end
        end
})
...
TEAM_HITMAN = AddExtraTeam("Hit man", {
	color = Color(82, 25, 5, 255),
	model = "models/player/gman_high.mdl",
	description = [[You place hits on players.]],
	weapons = {"weapon_bugbait"},
	command = "hobo",
	max = 5,
	salary = 35,
...
TEAM_SWAT = AddExtraTeam("S.W.A.T. Agent", {
	color = Color(40, 21, 20, 255),
	model = "models/player/swat.mdl",
	description = [[You're swat. You stay at S.W.A.T. spawn to called to a shootout, or raid.]],
	weapons = {"weapon_real_cs_m4a1","arrest_stick","stun_stick","unarrest_stick","weapon_real_cs_five-seven"},
	command = "swat",
	max = 3,
	salary = 35,
	admin = 0,
...
TEAM_SWAT = AddExtraTeam("S.W.A.T. Leader", {
	color = Color(40, 21, 21, 255),
	model = "models/player/gasmask.mdl",
	description = [[You're swat. You stay at S.W.A.T. spawn to called to a shootout, or raid. You are the leader, you lead you're swat. (VIP ONLY!) ]],
	weapons = {"weapon_real_cs_m4a1","arrest_stick","stun_stick","unarrest_stick","weapon_real_cs_five-seven"},
	command = "swatleader",
	max = 1,
	salary = 35,
...
TEAM_MANAGER = AddExtraTeam("Motel Manager", {
	color = Color(82, 25, 5, 255),
	model = "models/player/hostage/hostage_02.mdl",
	description = [[You own the Motel, you can fire workers. (WARNING: FIREING WORKERS DOSE NOT WORK, ASK FOR A ADMIN TO DEMOTE THE WORKER YOU WANT FIRED!!)]],
	weapons = {""},
	command = "motelmanager",
	max = 1,
	salary = 50,
	admin = 0,
	vote = false,
...
TEAM_MOTELWORKER = AddExtraTeam("Motel Worker", {
	color = Color(82, 25, 5, 255),
	model = "models/player/hostage/hostage_01.mdl",
	description = [[You work in the motels.]],
	weapons = {""},
	command = "motelworker",
	max = 3,
	salary = 35,
...
AddDoorGroup("Rebels", TEAM_GANG, TEAM_MOB)
AddDoorGroup("Motel", TEAM_MANAGER, TEAM_MOTALWORKER)
AddDoorGroup("Taxi's!", TEAM_TAXI, TEAM_BUS)
...
GM:AddGroupChat(TEAM_POLICE, TEAM_MAYOR, TEAM_CHIEF, TEAM_SWAT)
